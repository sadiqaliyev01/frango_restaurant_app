import 'package:frango_restaurant_app/data/models/remote/verify_email_response.dart';
...
class VerifyEmailRepository implements VerifyEmailContractor {
  ...
  @override
  Future<VerifyEmailResponse> verifyEmail({required String email}) {
    return _verifyEmailService.verifyEmail(email: email);
  }
}
